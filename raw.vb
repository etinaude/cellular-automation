...
Function find_value(inp As String) As Integer
    ...
    Select Case inp
		Case Is = "111"
			find_value = Range(table).Offset(0, xOff).Value
		Case Is = "110"
			find_value = Range(table).Offset(1, xOff).Value
		Case Is = "101"
			find_value = Range(table).Offset(2, xOff).Value
		Case Is = "100"
			find_value = Range(table).Offset(3, xOff).Value
		Case Is = "011"
			find_value = Range(table).Offset(4, xOff).Value
		Case Is = "010"
			find_value = Range(table).Offset(5, xOff).Value
		Case Is = "001"
			find_value = Range(table).Offset(6, xOff).Value
		Case Is = "000"
			find_value = Range(table).Offset(7, xOff).Value
		Case Else
			find_value = 2
    End Select
End Function